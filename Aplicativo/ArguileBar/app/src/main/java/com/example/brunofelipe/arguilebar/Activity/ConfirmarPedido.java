...
//                newModelItemArrayJson = gson.toJson(modelItemArrayJson);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                    ...
                    public Map<String, String> getParams() throws AuthFailureError {
                        ...
                        if(countEssencia == 0) {
                            Toast.makeText(getApplicationContext(), "Não foi pedido nenhuma essencia", Toast.LENGTH_LONG).show();
                        }
                        if(countEssencia == 1) {
                        ...
                        if(countBebida == 0) {
                            Toast.makeText(getApplicationContext(), "Não foi pedido nenhuma bebida", Toast.LENGTH_LONG).show();
                            }
                        } if(countBebida == 1) {
                            param.put("idBebida", String.valueOf(itemBebida1.getIdBebida()));
                        }if(countBebida == 2) {
                            param.put("idBebida", String.valueOf(itemBebida1.getIdBebida()));
                            param.put("idBebida2", String.valueOf(itemBebida2.getIdBebida()));
                        }if(countBebida == 3) {
                            param.put("idBebida", String.valueOf(itemBebida1.getIdBebida()));
                            param.put("idBebida2", String.valueOf(itemBebida2.getIdBebida()));
                            param.put("idBebida3", String.valueOf(itemBebida3.getIdBebida()));
                        }if(countBebida == 4) {
                            param.put("idBebida", String.valueOf(itemBebida1.getIdBebida()));
                            param.put("idBebida2", String.valueOf(itemBebida2.getIdBebida()));
                            param.put("idBebida3", String.valueOf(itemBebida3.getIdBebida()));
                            param.put("idBebida4", String.valueOf(itemBebida4.getIdBebida()));
                        }if(countBebida == 5) {
                            param.put("idBebida", String.valueOf(itemBebida1.getIdBebida()));
                            param.put("idBebida2", String.valueOf(itemBebida2.getIdBebida()));
                            param.put("idBebida3", String.valueOf(itemBebida3.getIdBebida()));
                            param.put("idBebida4", String.valueOf(itemBebida4.getIdBebida()));
                            param.put("idBebida5", String.valueOf(itemBebida5.getIdBebida()));
                        }
